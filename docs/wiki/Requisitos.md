...
- Login e cadastro: POST /auth/login, POST /auth/register
- Dados financeiros: GET /usuarios/{id}/receitas, GET /usuarios/{id}/despesas
- Ambiente: Node.js 18+, npm 9+, VITE_API_BASE configurado
